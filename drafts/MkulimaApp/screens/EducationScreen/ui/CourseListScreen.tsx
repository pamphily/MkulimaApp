...
// Import the stack param list from your EducationStack
  ...
  return (
    ...
    >
      ...
      <FlatList
        ...
        scrollEnabled={false} // entire view scrolls via KeyboardAwareScrollView
      />
    </KeyboardAwareScrollView>
  );
};
...
const styles = StyleSheet.create({
  ...
  categoriesContainer: { alignItems: 'center', paddingLeft: 0 },
  categoryChip: {
    borderWidth: 1,
    borderColor: '#888',
    borderRadius: 20,
