...
// Local imports
require("./chat.css");
var chatbox_1 = __importDefault(require("./chatbox"));
var icons_1 = require("../assets/icons");
var illustrations_1 = require("../assets/illustrations");
var chat_id_handler_1 = require("./services/chat-id-handler");
var Chat = function (_a) {
    ...
    var _v = (0, react_1.useState)(false), open = _v[0], setOpen = _v[1];
    var _w = (0, react_1.useState)((0, chat_id_handler_1.getChatId)()), id = _w[0], setId = _w[1];
    var _x = (0, react_1.useState)(false), showPopup = _x[0], setShowPopup = _x[1];
    var _y = (0, react_1.useState)(false), dontShowPopup = _y[0], setDontShowPopup = _y[1];
    ...
    return (react_1.default.createElement("div", { className: "sarufi-chat-container ".concat((theme === null || theme === void 0 ? void 0 : theme.placement) === "left" ? "sarufi-left-align" : "sarufi-right-align", " ").concat(open ? "open" : "", "\n      ").concat(open ? "sarufi-shadow-xl" : "sarufi-flex-center"), style: __assign(__assign({ position: "fixed", 
            ...
            : {})), style) },
        !open && (react_1.default.createElement("button", { className: "sarufi-shadow-xl ".concat(showPopup && "sarufi-floating"), style: {
            ...
            react_1.default.createElement(illustrations_1.SarufiIcon, { size: (theme === null || theme === void 0 ? void 0 : theme.buttonSize) === "lg"
                    ? 40
                    : (theme === null || theme === void 0 ? void 0 : theme.buttonSize) === "sm"
                        ? 20
                        : 30 }),
            react_1.default.createElement("div", { style: {
                ...
                react_1.default.createElement("p", { style: { fontWeight: "bold" } }, (_m = theme === null || theme === void 0 ? void 0 : theme.bubbleTitle) !== null && _m !== void 0 ? _m : "Need Help?"),
                react_1.default.createElement("p", null, (_o = theme === null || theme === void 0 ? void 0 : theme.bubbleSubTitle) !== null && _o !== void 0 ? _o : "Ask me")))),
        react_1.default.createElement("div", { style: {
                height: "100%",
            ...
            react_1.default.createElement("div", { className: "sarufi-flex-wide text-neutral-0", style: {
                    // height: "42px",
                ...
                react_1.default.createElement("div", { className: "sarufi-flex sarufi-align-center" },
                    react_1.default.createElement("div", { className: "sarufi-flex-center", style: {
                        ...
                        react_1.default.createElement(illustrations_1.SarufiIcon, { style: {
                    ...
                    react_1.default.createElement("div", null,
                        react_1.default.createElement("p", { className: "sarufi-ellipsed-text", style: {
                                fontWeight: 600,
                                marginBottom: "3px",
                ...
                react_1.default.createElement("div", { className: "flex-center" },
                    react_1.default.createElement("button", { className: "flex-center sarufi-button", onClick: function () { return setOpen(false); }, style: {
                            border: "none",
                            background: "none",
                            color: "white",
                            cursor: "pointer",
                        ...
                        react_1.default.createElement(icons_1.MinusIcon, { size: 16, className: "text-neutral-0" })),
                    react_1.default.createElement("button", { className: "flex-center sarufi-button", onClick: function () {
                            setOpen(false);
                            setId((0, chat_id_handler_1.getChatId)(true));
                        }, style: {
                            border: "none",
                            background: "none",
                            color: "white",
