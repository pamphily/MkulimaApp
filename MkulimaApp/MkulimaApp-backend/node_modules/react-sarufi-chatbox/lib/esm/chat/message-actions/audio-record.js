...
// Local imports
import { CancelRecordIcon, MicIcon, Pause, Play, 
// RecordingAudioIcon,
SendIcon, } from "../../assets/icons";
var RecordAudio = function (_a) {
    ...
    var _d = useState(0), recordingDuration = _d[0], setRecordingDuration = _d[1];
    var _e = useState(0), currentPlayingTime = _e[0], setCurrentPlayingTime = _e[1];
    ...
    return (React.createElement("div", { style: {
        ...
        !isRecording && !(recordedAudio === null || recordedAudio === void 0 ? void 0 : recordedAudio.blob) && (React.createElement("button", { title: "Record Audio", onClick: handleStartRecording, disabled: isRecording || disabled, style: {
                display: "flex",
            ...
            React.createElement(MicIcon, { size: 20 }))),
        (isRecording || (recordedAudio === null || recordedAudio === void 0 ? void 0 : recordedAudio.blob)) && (React.createElement("button", { onClick: function () {
            ...
            React.createElement(CancelRecordIcon, { size: 24 }))),
        isRecording && !(recordedAudio === null || recordedAudio === void 0 ? void 0 : recordedAudio.blob) && (React.createElement("div", { style: {
                // position: "absolute",
                right: "1rem",
                bottom: "1rem",
                display: "flex",
        ...
        (recordedAudio === null || recordedAudio === void 0 ? void 0 : recordedAudio.blob) && (React.createElement("div", { style: {
                display: "flex",
                // flexDirection: "column",
                alignItems: "center",
            ...
            React.createElement("div", { style: {
                ...
                React.createElement("audio", { ref: audioPlayerRef, key: recordedAudio === null || recordedAudio === void 0 ? void 0 : recordedAudio.blob, onEnded: handleAudioEnd, onTimeUpdate: handleTimeUpdate, style: {
                        display: "none",
                    } },
                    React.createElement("source", { src: recordedAudio === null || recordedAudio === void 0 ? void 0 : recordedAudio.blob, type: "audio/wav" }),
                    "Your browser does not support the audio element."),
                React.createElement("div", { style: {
                        marginRight: "1rem",
                    } },
                    React.createElement("button", { onClick: handlePlayPause }, isPlaying ? React.createElement(Pause, { size: 20 }) : React.createElement(Play, { size: 20 }))),
                React.createElement("p", null,
                    formatDuration(currentPlayingTime),
                    " :",
                    " ",
                    formatDuration(recordingDuration))),
            React.createElement("button", { onClick: submit, disabled: !!(recordedAudio === null || recordedAudio === void 0 ? void 0 : recordedAudio.error) || disabled, style: {
                    color: "var(--sarufi-primary-color)",
                } },
                React.createElement(SendIcon, { size: 24 }))))));
};
