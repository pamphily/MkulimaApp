...
var Chatbox = function (_a) {
    ...
    var ref = useRef(null);
    var _e = useState(id), chatId = _e[0], setChatId = _e[1];
    var isRecording = useState(false)[0];
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { ref: ref, id: "sarufi-chat-container", style: {
            ...
            React.createElement("div", { style: {
                ...
                React.createElement("div", { className: "sarufi-message-body", style: {
                        maxWidth: 280,
                ...
                React.createElement("ul", null, chats === null || chats === void 0 ? void 0 :
                    chats.map(function (chat, index) { return (React.createElement(Chat, { chat: chat, key: index, onSubmit: onSubmit, primaryColor: primaryColor, mode: mode, fontFamily: fontFamily, fontSize: fontSize, index: index })); }),
                    loading && (React.createElement("div", { className: "sarufi-message-body", style: {
                            background: "var(--sarufi-received-box-bg)",
                            padding: "6px 8px 8px 9px",
                            marginTop: ".7rem",
                            position: "relative",
        ...
        React.createElement("div", { className: "sarufi-flex-wide", style: {
            ...
            !isRecording && (React.createElement("form", { style: {
                    position: "relative",
                    marginRight: ".5rem",
                    width: "100%",
            ...
            React.createElement("div", { className: "sarufi-flex-center message-actions", style: {
                    color: mode === "light" ? "#525252" : "white",
                    width: isRecording ? "100%" : "auto",
                } }, !isRecording && (React.createElement(React.Fragment, null,
                React.createElement(DatePicker, { onSelect: function (d) {
...
var Chat = function (_a) {
    ...
    return (React.createElement("li", { className: "".concat((chat === null || chat === void 0 ? void 0 : chat.sent) ? "sarufi-flex-end" : ""), style: {
        ...
        !(chat === null || chat === void 0 ? void 0 : chat.sent) && (React.createElement("div", { style: {
            ...
            React.createElement(SarufiIcon, { size: 20, style: {
                    color: primaryColor,
                } }))),
        React.createElement("div", null,
            React.createElement(Media, { chat: chat, mode: mode, fontFamily: fontFamily, fontSize: fontSize, messageIndex: index }),
            React.createElement("div", { className: "sarufi-message-body  ".concat((chat === null || chat === void 0 ? void 0 : chat.sent) ? "sent" : ""), style: __assign({ background: (chat === null || chat === void 0 ? void 0 : chat.sent)
